                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    	<c:forEach var = "t" items = "${listTasks}" varStatus="loop">
                                    		 <tr>
                                            	<td>${loop.index + 1}</td>
                                            	<td>${t.name}</td>
                                            	<td>${t.project.name}</td>
                                            	<td>${t.user.fullName}</td>
                                            	<td><fmt:formatDate value="${t.startDateSQL}" pattern="dd/MM/yyyy"/></td>
												<td><fmt:formatDate value="${t.endDateSQL}" pattern="dd/MM/yyyy"/></td>
                                            	<td>${t.status}</td>
                                            	<td>
