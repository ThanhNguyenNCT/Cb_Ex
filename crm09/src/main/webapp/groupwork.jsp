                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                    	<c:forEach var="p" items="${listProjects}" varStatus="loop">
                                    		<tr>
                                            	<td>${loop.index + 1}</td>
                                            	<td>${p.name}</td>
												<td><fmt:formatDate value="${p.startDateSQL}" pattern="dd/MM/yyyy"/></td>
												<td><fmt:formatDate value="${p.endDateSQL}" pattern="dd/MM/yyyy"/></td>
                                            	<td>
