                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="task-add" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name = "id_project" class="form-control form-control-line">
                                        	<c:forEach var = "p" items = "${listProjects}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name = "name-task" type="text" placeholder="Tên công việc"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name = "start_task" type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name = "end_task" type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
