	...
	%>
    	<div id="unauthorizedModal" class="modal">
        	<div class="modal-content">
            	...
            	<p>
                	<%= "false".equals(login) ? "Bạn chưa đăng nhập. Hãy đăng nhập để sử dụng chức năng." : "Bạn không có quyền truy cập vào chức năng này." %>
            	</p>
            	<button onclick="closeUnauthorizedModal()">OK</button>
